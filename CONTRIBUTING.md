# Contributing to harn-gitea-connector

This repository does not accept external contributions.

## Why

`harn-gitea-connector` is a generated and fleet-managed connector package. It carries the
Gitea side of the Harn connector contract and almost nothing else. Its
...
- Found a bug in how this connector handles Gitea, or want a connector that
